...
if __name__ == '__main__':
    ...
    oss_data_list = add_bts_name_to_list_nsn(wcel_list,wbts_list)
    list_for_antenna_file = combined_list_from_rpdb_and_oss_to_antennas_file(oss_data_list, rpdb_list)
        ...
        for row in range(len(list_for_antenna_file)):
            #for el in range(len(list_for_antenna_file[row])):
                ...
                antennas_file.write(f"{tech}\t"
                                    ...
                                    f"{'N/A'}\t"
                                    f"{list_for_antenna_file[row][7]}\t"
                                    f"{list_for_antenna_file[row][8]}\t"
